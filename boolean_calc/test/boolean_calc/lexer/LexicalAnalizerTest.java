...
public class LexicalAnalizerTest {
	...
	public void result_not_null_test() {
		...
		LexicalResult result = parser.analize("");
	...
	public void one_test() {
		LexicalAnalyzer parser = new LexicalAnalyzer();
		LexicalResult result = parser.analize("1");
	...
	public void zero_test() {
		LexicalAnalyzer parser = new LexicalAnalyzer();
		LexicalResult result = parser.analize("0");
	...
	public void var_test() {
		LexicalAnalyzer parser = new LexicalAnalyzer();
		LexicalResult result = parser.analize("x");
	...
	public void two_test() {
		LexicalAnalyzer parser = new LexicalAnalyzer();
		LexicalResult result = parser.analize("2");
	...
	public void and_expression_test() {
		LexicalAnalyzer parser = new LexicalAnalyzer();
		LexicalResult result = parser.analize("x and y");
	...
	public void source_test() {
		...
		LexicalAnalyzer parser = new LexicalAnalyzer();
		LexicalResult result = parser.analize(source);
